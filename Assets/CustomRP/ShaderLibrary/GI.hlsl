...
#define CUSTOM_GI_INCLUDED
    ...
    #define GI_FRAGMENT_DATA(input) input.lightMapUV * unity_LightmapST.xy + unity_LightmapST.zw
#else
...
float3 SampleLightProbe(Surface surfaceWS) {
        ...
        if (unity_ProbeVolumeParams.x) {
            ...
            float4 cofficients[7];
            cofficients[0] = unity_SHAr;
            cofficients[1] = unity_SHAg;
            cofficients[2] = unity_SHAb;
            cofficients[3] = unity_SHBr;
            cofficients[4] = unity_SHBg;
            cofficients[5] = unity_SHBb;
            cofficients[6] = unity_SHC;
            return max(0.0, SampleSH9(cofficients, surfaceWS.normal));
        }
    #endif
}
